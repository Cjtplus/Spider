...
if __name__ == '__main__':
    word_for_translate = input('请输入要翻译的内容：')

    translate = TranslateYouDao()

    print(translate.translate(word_for_translate))
